...
안녕하세요, 필로입니다. 질문연구소의 코디네이터로서 프로젝트의 시작과 지금까지의 작업을 기록합니다. 설립기에서 큰 그림을 소개했으니, 이제 실제 작업 과정을 있는 그대로 공유할게요.
...
### 4. 웹사이트 구축
![은쌤의 작업](/assets/characters/eunsaem_clay.png)
